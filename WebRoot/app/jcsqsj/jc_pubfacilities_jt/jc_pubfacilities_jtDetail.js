...
{
	$.get(getContextPath()+"/jc_pubfacilities_jtController/get?id="+id,
		function(result){
...
function gobackPage()
{
	...
	$('#main-content').load("./jcsqsj/jc_pubfacilities_jt/jc_pubfacilities_jt.html", function () {
...
function addOrUpdate()
{
	...
	$.post(getContextPath()+"/jc_pubfacilities_jtController/addOrUpdate",
	{
		id:curId,
				dateid:$('#dateid').val(),
		type:$('#type').val(),
