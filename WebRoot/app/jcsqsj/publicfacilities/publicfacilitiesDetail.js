...
{
	$.get(getContextPath()+"/publicfacilitiesController/get?id="+id,
		function(result){
...
function gobackPage()
{
	...
	$('#main-content').load("./publicfacilities/publicfacilities.html", function () {
...
function addOrUpdate()
{
	...
	$.post(getContextPath()+"/publicfacilitiesController/addOrUpdate",
	{
		id:curId,
				dateid:$('#dateid').val(),
		type:$('#type').val(),
