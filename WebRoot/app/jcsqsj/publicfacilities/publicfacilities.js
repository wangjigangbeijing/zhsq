...
function load()
{
 ...
 var objState = $('#objStateQuery').val();
	...
	$.get(getContextPath()+'/publicfacilitiesController/load?type='+type+'&objname='+objname+'&deptname1='+deptname1+'&isincommunity='+isincommunity+'&material='+material+'&form='+form+'&objState='+objState+'&',
	function(result){
...
function viewDetail(id)
{
	...
	curId = id;
	$.get(getContextPath()+"/publicfacilitiesController/get?id="+curId,
		function(result){
			var obj = jQuery.parseJSON(result);  
			if(obj.success)
			{
...
{
	curId = id;
	$('#main-content').load("./jcsqsj/publicfacilities/publicfacilitiesDetail.html", function () {
...
function deleteData(id)
{
	$.confirm({
		...
		confirm: function(button) {
			...
			$.post(getContextPath()+"/publicfacilitiesController/delete",
			{
				id:id
			},
			function(result){
