...
$(document).ready(function (){
	...
	if(haveRight('jc_culturefacilities_add') == false)
	{
		$('#btnAdd1').hide();
		$('#btnAdd2').hide();
	}
...
{
	curId = id;
	$('#main-content').load("./jcsqsj/culturefacilities/culturefacilitiesDetail.html", function () {
		$('#confirmBtn').hide();
...
function deleteData(id)
{
	$.confirm({
		...
		confirm: function(button) {
			...
			$.post(getContextPath()+"/culturefacilitiesController/delete",
			{
				id:id
			},
			function(result){
