...
{
	$.get(getContextPath()+"/volunteerteamController/get?id="+id,
		function(result){
...
function gobackPage()
{
	...
	$('#main-content').load("./jcsqsj/volunteerteam/volunteerteam.html", function () {
...
function addOrUpdate()
{
	...
	$.post(getContextPath()+"/volunteerteamController/addOrUpdate",
	{
		id:curId,
				dateid:$('#dateid').val(),
		name:$('#name').val(),
