...
function load()
{
 ...
 var objState = $('#objStateQuery').val();
	...
	$.get(getContextPath()+'/jc_pubfacilities_hjController/load?type='+type+'&objname='+objname+'&deptname1='+deptname1+'&isincommunity='+isincommunity+'&material='+material+'&form='+form+'&objState='+objState+'&',
	function(result){
