...
{
	$.get(getContextPath()+"/jc_pubfacilities_hjController/get?id="+id,
		function(result){
...
function gobackPage()
{
	...
	$('#main-content').load("./jcsqsj/jc_pubfacilities_hj/jc_pubfacilities_hj.html", function () {
...
function addOrUpdate()
{
	...
	$.post(getContextPath()+"/jc_pubfacilities_hjController/addOrUpdate",
	{
		id:curId,
		dateid:$('#dateid').val(),
		type:$('#type').val(),
