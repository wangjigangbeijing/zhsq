...
function load()
{
 ...
 var parkName = $('#parkNameQuery').val();
	...
	$.get(getContextPath()+'/jc_tc_tcccrkController/load?name='+name+'&parkName='+parkName+'&',
	function(result){
		...
		if(obj.success)
		{
			dataTable = $('#dataTable').dataTable( {
				...
				"data":obj.list,
				"columns": [
										{ 'data': 'rkType' ,'sClass':'text-center'},
...
{
	curId = id;
	$('#main-content').load("./jcsqsj/jc_tc_tcccrk/jc_tc_tcccrkDetail.html", function () {
...
function deleteData(id)
{
	$.confirm({
		...
		confirm: function(button) {
			...
			$.post(getContextPath()+"/jc_tc_tcccrkController/delete",
			{
				id:id
			},
			function(result){
