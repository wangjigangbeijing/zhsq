...
var editTableInitialized = false;

$(document).ready(function (){
	
	$('#btnAdd').click(addTable);
	...
	$.get(getContextPath()+"/userController/loadUser",
		function(result){
			...
			if(obj.success)
			{
				...
				{
					var user = obj.userList[i];
					
					userArr[i] = "<option value='" + user.id + "'>" + user.userName + "</option>";						
				}
				$('#tableManager').html(userArr.join(''));
			}
		}
	);

	$("#copycreat").change(function() {		
