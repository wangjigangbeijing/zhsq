...
function loadmyslfw()
{
	...
	$.get(getContextPath()+'/myslfwController/getmysldatalist?bt=' + bt + '&lb=' + lb + '&fkrname=' + fkrname + '&status=' + status,
	function(result){
...
function loadstatus()
{
	$.get(getContextPath()+"/flowtemplateController/loadtemplatestatus?service=mysl",
		function(result){
			var obj = jQuery.parseJSON(result);  
			if(obj.success)
			{
...
function deleteData(id)
{
	$.confirm({
		...
		confirm: function(button) {
			...
			$.post(getContextPath()+"/myslfwController/delete",
			{
				id:id
			},
			function(result){
...
function enterFlow(id){
	...
	$('#main-content').load("./nfw/myslfwFlowDetail.html", function () {
