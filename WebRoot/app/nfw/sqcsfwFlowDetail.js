...
function loadTemplateProcess(id){
	$.get(getContextPath()+"/flowtemplateController/getdatatemplateprocessinfo?service=sqcs&dataid=" + id,
		function(result){
...
function loadprocessdata(id){
	$.get(getContextPath()+"/flowtemplateController/loadprocessdata?service=sqcs&dataid=" + id,
		function(result){
			var obj = jQuery.parseJSON(result);  
			if(obj.success)
			{
	...
	$.get(getContextPath()+"/sqcsfwController/get?id="+id,
		function(result){
			...
			if(obj.success)
			{
				...
				$('#sjcd').html(obj.data.sjcd);
				$('#sjdl').html(obj.data.sjdl);
				$('#sjxl').html(obj.data.sjxl);
				$('#dsr').html(obj.data.dsr);
				$('#dsrlxdh').html(obj.data.dsrlxdh);
				$('#sjxq').html(obj.data.sjxq);
				$('#bz').html(obj.data.bz);
				/*
