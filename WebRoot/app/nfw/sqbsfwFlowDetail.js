...
function loadTemplateProcess(id){
	$.get(getContextPath()+"/flowtemplateController/getdatatemplateprocessinfo?service=sqbs&dataid=" + id,
		function(result){
...
function loadprocessdata(id){
	$.get(getContextPath()+"/flowtemplateController/loadprocessdata?service=sqbs&dataid=" + id,
		function(result){
			var obj = jQuery.parseJSON(result);  
			if(obj.success)
			{
	...
	$.get(getContextPath()+"/sqbsfwController/get?id="+id,
		function(result){
			...
			if(obj.success)
			{
				...
				$('#blsxdl').html(obj.data.blsxdl);
				$('#blsxxl').html(obj.data.blsxxl);
				$('#xq').html(obj.data.xq);
				$('#bz').html(obj.data.bz);
				/*
