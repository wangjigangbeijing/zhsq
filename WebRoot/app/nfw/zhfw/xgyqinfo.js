...
function load()
{
 ...
 var hsjcjieguo = $('#hsjcjieguoQuery').val();
	...
	$.get(getContextPath()+'/xgyqinfoController/load?name='+name+'&mobile='+mobile+'&address='+address+'&quezhen='+quezhen+'&qzdate='+qzdate+'&yisi='+yisi+'&mijie='+mijie+'&hsjc='+hsjc+'&hsjcjieguo='+hsjcjieguo+'&',
	function(result){
...
function viewDetail(id)
{
	...
	curId = id;
	$.get(getContextPath()+"/xgyqinfoController/get?id="+curId,
		function(result){
			var obj = jQuery.parseJSON(result);  
			if(obj.success)
			{
...
{
	curId = id;
	$('#main-content').load("./nfw/zhfw/xgyqinfoDetail.html", function () {
...
function deleteData(id)
{
	$.confirm({
		...
		confirm: function(button) {
			...
			$.post(getContextPath()+"/xgyqinfoController/delete",
			{
				id:id
			},
			function(result){
