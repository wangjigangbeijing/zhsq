...
function load()
{
 ...
 var date = $('#dateQuery').val();
 var type = $('#typeQuery').val();
 var hours = $('#hoursQuery').val();
 var content = $('#contentQuery').val();
 var files = $('#filesQuery').val();
 var owner = $('#ownerQuery').val();

	
	$.get(getContextPath()+'/worklogController/load?title='+title+'&date='+date+'&type='+type+'&hours='+hours+'&content='+content+'&files='+files+'&owner='+owner+'&',
	function(result){
...
function viewDetail(id)
{
	...
	curId = id;
	$.get(getContextPath()+"/worklogController/get?id="+curId,
		function(result){
			var obj = jQuery.parseJSON(result);  
			if(obj.success)
			{
...
{
	curId = id;
	$('#main-content').load("./worklog/worklogDetail.html", function () {
...
function deleteData(id)
{
	$.confirm({
		...
		confirm: function(button) {
			...
			$.post(getContextPath()+"/worklogController/delete",
			{
				id:id
			},
			function(result){
