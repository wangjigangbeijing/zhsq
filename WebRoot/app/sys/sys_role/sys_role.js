...
function load()
{
 ...
 var code = $('#codeQuery').val();
	...
	$.get(getContextPath()+'/sysRoleController/load?name='+name+'&code='+code+'&',
	function(result){
...
{
	curId = id;
	$('#main-content').load("./sys/sys_role/sys_roleDetail.html", function () {
...
function deleteData(id)
{
	$.confirm({
		...
		confirm: function(button) {
			...
			$.post(getContextPath()+"/sysRoleController/delete",
			{
				id:id
			},
			function(result){
