...
function load()
{
	...
	$.get(getContextPath()+'/{FirstLower}Controller/load?{QueryStr}',
	function(result){
...
function viewDetail(id)
{
	...
	curId = id;
	$.get(getContextPath()+"/{FirstLower}Controller/get?id="+curId,
		function(result){
			var obj = jQuery.parseJSON(result);  
			if(obj.success)
			{
...
{
	curId = id;
	$('#main-content').load("./{FirstLower}/{FirstLower}Detail.html", function () {
...
function deleteData(id)
{
	$.confirm({
		...
		confirm: function(button) {
			...
			$.post(getContextPath()+"/{FirstLower}Controller/delete",
			{
				id:id
			},
			function(result){
