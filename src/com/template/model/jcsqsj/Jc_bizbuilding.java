...
@Entity
@Table(name = "JC_BIZBUILDING")
@DynamicInsert(true)
@DynamicUpdate(true)
public class Jc_bizbuilding implements java.io.Serializable {
@Id
...
@Column(name = "orginbuilding", nullable = true)
public Integer orginbuilding;
public Integer getorginbuilding()
{
	return orginbuilding;
}
public void setorginbuilding(Integer orginbuilding)
{
	this.orginbuilding = orginbuilding;
}
